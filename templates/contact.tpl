...
<section class="contact-page visible-when-content-ready">
	<div class="container">
		<div class="row">
			{% if has_contact_info and not is_order_cancellation %}
				<div class="col-md-3">
					...
					{% endif %}
					{% include "snipplets/contact-links.tpl" with {btn_link: true, with_icons: true} %}
				</div>
			{% endif %}
			{% if is_order_cancellation %}
				<div class="col-md-3">
					<div class="text-center text-md-left mb-4">
						...
						<a class="btn-link" href="{{ status_page_url }}"><strong>{{'Ver detalle de la compra >' | translate}}</strong></a>
					</div>
					{% if has_contact_info %}

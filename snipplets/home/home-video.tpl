{% if settings.video_embed %}
    <section data-store="home-video">
        <div class="js-section-video section-video-home" data-transition="fade-in-up">
                                ...
                                <div class="container">
                                    <div class="home-video-text">
                                        ...
                                        {% if settings.video_text %}
                                            <p class="mb-3 pl-1">{{ settings.video_text }}</p>
                                        {% endif %}
                                        {% if settings.video_button and settings.video_button_url %}
                                            <a href="{{ settings.video_button_url }}" class="btn btn-default d-inline-block">{{ settings.video_button }}</a>
                                        {% endif %}
                                    </div>
                                </div>
                            {% endif %}

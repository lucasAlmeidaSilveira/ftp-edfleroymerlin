                ...
                {% if store.country == 'BR' %}
                    <div class="price-container">
                        <span class="d-inline-block">
                           <h3 id="compare_price_display" class="js-compare-price-display price-compare font-weight-normal" style="display:block;">{{"28000" | money }}</h3>
                        </span>
                        <span class="d-inline-block mr-3">
                            <div class="js-price-display h1" id="price_display">{{"18200" | money }}</div>
                        </span>
                    </div>
                {% else %}
                    <div class="price-container">
                        <span class="d-inline-block">
                           <h3 id="compare_price_display" class="js-compare-price-display price-compare font-weight-normal" style="display:block;">{{"280000" | money }}</h3>
                        </span>
                        <span class="d-inline-block mr-3">
                            <div class="js-price-display h1" id="price_display">{{"182000" | money }}</div>
                        </span>
                    </div>
                {% endif %}
...
<section id="related-products" class="section-products-related position-relative" data-store="related-products">
    <div class="container">
        <div class="row mb-3 pb-2 align-items-center">
            <div class="col-12">
                <h3 class="mb-1">{{ "Productos relacionados" | translate }}</h3>
            </div>
        </div>
        <div class="row">

...
<div class="js-product-slider-placeholder d-md-none product-placeholder-container {% if product.images_count == 1 %}hidden-when-content-ready{% endif %}">
    ...
    <div class="placeholder-icon">
        {% include "snipplets/svg/bag.tpl" with {svg_custom_class: "icon-inline icon-2x svg-icon-text opacity-50"} %}
    </div>

{% if product_detail %}
	...
	{% if calculator_label %}
	<div class="js-shipping-add-product-label mb-2" {% if hide_free_shipping_minimum %}style="display: none;"{% endif %}>
	{% else %}
	<div class="js-free-shipping-add-product-title position-absolute transition-up w-100 {% if not hide_free_shipping_minimum %}transition-up-active{% endif %} mb-2">
	{% endif %}

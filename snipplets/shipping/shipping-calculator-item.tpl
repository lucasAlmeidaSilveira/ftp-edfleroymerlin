            ...
            <div class="radio-button-label">
                ...
                <div class="radio-button-text row"> 
                    <div class="col font-small px-0">
                        ...
                        {% if option.time %}
                            <div class="shipping-label {% if option.suboptions is not empty or option.payment_rules %}mb-2{% endif %}" data-component="option.date">
                        ...
                        <div class="col-auto text-right" data-component="option.price">
                            <p class="mb-0 d-inline-block {% if option.cost.value == 0  %}text-accent{% endif %}">
                                ...
                                {% if option.cost.value == 0 and option.old_cost.value %}
                                    <div class="price-compare font-small opacity-50 mr-0 mt-1">{{option.old_cost}}</div>
                                {% endif %}
                            </p>
                        </div>
                    {% endif %}

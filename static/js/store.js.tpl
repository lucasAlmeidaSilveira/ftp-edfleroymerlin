...
lazySizesConfig.hFac = 0.4;
    ...
    {% set has_header_banners = settings.head_informative_banner_01_show or settings.head_informative_banner_02_show %}
    ...
    var slidesPerViewDesktopVal = {% if columns_desktop == 4 %}4{% elseif columns_desktop == 5 %}5{% else %}6{% endif %};
	...
	{% if template == 'home' %}
        ...
        {% if has_featured_products_slider or has_new_products_slider or has_sale_products_slider %}
            ...
            {% if has_featured_products_slider %}
                ...
                {% endif %}
                    ...
                    breakpoints: {
                        768: {
                            slidesPerView: {% if "featured_products_image.jpg" | has_custom_image %}2{% else %}slidesPerViewDesktopVal{% endif %},
                        }
                    }
                });
        ...
        {% if settings.brands and settings.brands is not empty %}
            ...
            createSwiper('.js-swiper-brands', {
                ...
                on: {
                    ...
                    {% if settings.brands | length > 6 and settings.brands | length < 12  %}
                        beforeInit: function () {
                            if (window.innerWidth > 768) {
        ...
        {% if settings.banner_slider and (settings.banner and settings.banner is not empty) %}
            ...
            {% set banner_auto_scroll = settings.banner_slider_autoscroll %}

            var bannerSpeed = {% if banner_auto_scroll %}5000{% else %}300{% endif %};
            var bannerAutoplay = {% if banner_auto_scroll %}{ delay: 0, disableOnInteraction: false }{% else %}false{% endif %};

            var bannersPerViewDesktopVal = {% if banner_columns_desktop == 8 %}8{% elseif banner_columns_desktop == 7 %}7{% elseif banner_columns_desktop == 6 %}6{% elseif banner_columns_desktop == 5 %}5{% elseif banner_columns_desktop == 4 %}4{% elseif banner_columns_desktop == 3 %}3{% elseif banner_columns_desktop == 2 %}2{% else %}1{% endif %};
            var bannersPerViewMobileVal ={% if banner_columns_mobile == 1 %}1{% elseif banner_columns_mobile == 2 %}2.25{% elseif banner_columns_mobile == 3 %}3{% elseif banner_columns_mobile == 4 %}4{% else %} 1.1{% endif %};
            ...
            createSwiper('.js-swiper-banners', {
                ...
                watchSlideProgress: true,
                watchSlidesVisibility: true,
                slideVisibleClass: 'js-swiper-slide-visible swiper-slide-visible',
        ...
        {% if settings.banner_promotional_slider and (settings.banner_promotional and settings.banner_promotional is not empty) %}
            ...
            {% set banner_promotional_auto_scroll = settings.banner_promotional_slider_autoscroll %}

            var bannerPromotionalSpeed = {% if banner_promotional_auto_scroll %}5000{% else %}300{% endif %};
            var bannerPromotionalAutoplay = {% if banner_promotional_auto_scroll %}{ delay: 0, disableOnInteraction: false }{% else %}false{% endif %};
            ...
            createSwiper('.js-swiper-banners-promotional', {
                ...
                watchSlidesVisibility: true,
                slideVisibleClass: 'js-swiper-slide-visible swiper-slide-visible',
                autoplay: bannerPromotionalAutoplay,
                speed: bannerPromotionalSpeed,
                loop: true,
                navigation: {
        ...
        {% if settings.banner_news_slider and (settings.banner_news and settings.banner_news is not empty) %}
            ...
            {% set banner_news_auto_scroll = settings.banner_news_slider_autoscroll %}

            var bannerNewsSpeed = {% if banner_news_auto_scroll %}5000{% else %}300{% endif %};
            var bannerNewsAutoplay = {% if banner_news_auto_scroll %}{ delay: 0, disableOnInteraction: false }{% else %}false{% endif %};
            ...
            createSwiper('.js-swiper-banners-news', {
                ...
                watchSlidesVisibility: true,
                slideVisibleClass: 'js-swiper-slide-visible swiper-slide-visible',
                autoplay: bannerNewsAutoplay,
                speed: bannerNewsSpeed,
                loop: true,
                clickable: true,
                navigation: {
                ...
                Fancybox.bind('[data-fancybox="product-gallery"]', {
                    ...
                    Carousel: {
                        Navigation: {
                            ...
                            prevTpl: '{% include "snipplets/svg/chevron-left.tpl" with {svg_custom_class: "icon-inline icon-lg svg-icon-invert"} %}',
                            nextTpl: '{% include "snipplets/svg/chevron-right.tpl" with {svg_custom_class: "icon-inline icon-lg svg-icon-invert"} %}',
                        },
                    },
